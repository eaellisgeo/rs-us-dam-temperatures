...
def rwGenSR(aoi = None, WATER_METHOD = 'Fmask', MAXDISTANCE = 4000, FILL_SIZE = 333, MAXDISTANCE_BRANCH_REMOVAL = 500):
######## Updated: changed default to Fmask for Collection 2
    
    grwl = ee.FeatureCollection("users/eeProject/grwl") #testing
